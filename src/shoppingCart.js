...
// Show/Hide the cart when click
// Show/Hide the cart when it has no items or when it goes from 0 to 1 
// Calculate an accurate total
// Hanfle multiple of the same item in the cart
...
//  localStorage.setItem('workouts', JSON.stringify(workouts));
    ...
    // Handle multipe of the same item in the cart
    // Calculate an accurate totale
...
function renderCartItems() {
    ...
    cartItemContainer.innerHTML = "" // clear the repetitive items 
